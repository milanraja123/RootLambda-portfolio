  ...
  return (
    ...
    >
      <div className="container relative">
        ...
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-medium text-center mt-6 leading-tight">
...
RootLambda wires AI into everything — your website, your app, your content, your videos, your marketing. We don&apos;t just build. We build systems that grow while you sleep.
        </p>
